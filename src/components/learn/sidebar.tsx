...
import { Home, Sparkles, BookOpenText, BookOpen, Headphones, PenLine, Mic, GraduationCap, Shield, LogOut, User, Users } from "lucide-react";
  ...
  return (
    <aside className="hidden md:flex md:w-64 md:flex-col md:p-4 md:h-screen md:sticky md:top-0">
      ...
      <nav className="flex-1 space-y-1">
        ...
        >
          <Users className={cn("h-5 w-5", pathname.startsWith("/community") && "text-primary")} />
          Cộng đồng
        </Link>
        <Link
          href="/profile"
