...
import { Shield, BookOpen, PenLine, Mic, Sparkles, BookOpenText, Headphones, Users, KeyRound, ExternalLink, GraduationCap, TrendingUp, Volume2, Music, Activity, Ear } from "lucide-react";
...
const nav = [
  ...
  { href: "/admin/voice-test", label: "Thử giọng Deepgram", icon: Ear },
