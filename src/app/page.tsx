    ...
    <main className="relative min-h-screen overflow-hidden">
      ...
      <section className="container pt-12 pb-20 md:pt-20 md:pb-28 text-center">
        <div className="mx-auto max-w-3xl">
          <span className="inline-flex items-center gap-1.5 rounded-full border bg-white/60 backdrop-blur px-3.5 py-1.5 text-xs font-semibold shadow-sm">
          ...
          <div className="mt-9 flex flex-wrap justify-center gap-3">
            ...
            <Button asChild size="xl" variant="outline" className="rounded-full bg-white/70 backdrop-blur">
      ...
      <section className="container pb-24">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {features.map((f) => (
            <div
              key={f.title}
              className="group relative overflow-hidden rounded-3xl border bg-card p-6 transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/5"
            >
