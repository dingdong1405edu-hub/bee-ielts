import {
  ...
  DIAGRAM_EXPENDITURE,
  DIAGRAM_TOURISTS,
  DIAGRAM_PHONE_OWNERSHIP,
  DIAGRAM_POPULATION,
  DIAGRAM_HOME_ENERGY,
  DIAGRAM_ENROLMENT,
  DIAGRAM_WORKING_HOURS,
  DIAGRAM_UNEMPLOYMENT,
  DIAGRAM_CHOCOLATE_PROCESS,
  DIAGRAM_LIBRARY,
  DIAGRAM_WATER_USE,
  DIAGRAM_MUSEUM,
  DIAGRAM_CRIME,
  ...
  DIAGRAM_COFFEE_TEA,
  DIAGRAM_TRANSPORT,
  DIAGRAM_LIFE_EXPECTANCY,
  DIAGRAM_SHOPPING,
  DIAGRAM_ELECTRICITY_MIX,
...
export const WRITING_TASKS: WritingTaskData[] = [
  ...
  {
    taskType: 1,
    prompt: "The bar chart below shows the percentage of people in four age groups who owned a smartphone in 2010 and in 2022.\n\nSummarise the information by selecting and reporting the main features, and make comparisons where relevant.\n\nWrite at least 150 words.",
    diagramSvg: DIAGRAM_PHONE_OWNERSHIP,
    minWords: 150,
    timeLimit: 1200,
  },
  {
    taskType: 1,
    prompt: "The line graph below shows the population of three countries (Nigeria, Brazil and Japan) between 1980 and 2020.\n\nSummarise the information by selecting and reporting the main features, and make comparisons where relevant.\n\nWrite at least 150 words.",
    diagramSvg: DIAGRAM_POPULATION,
    minWords: 150,
    timeLimit: 1200,
  },
  {
    taskType: 1,
    prompt: "The pie charts below show how energy is used in two different households.\n\nSummarise the information by selecting and reporting the main features, and make comparisons where relevant.\n\nWrite at least 150 words.",
    diagramSvg: DIAGRAM_HOME_ENERGY,
    minWords: 150,
    timeLimit: 1200,
  },
  {
    taskType: 1,
    prompt: "The table below shows the number of students enrolled in four university faculties in 2018, 2020 and 2022.\n\nSummarise the information by selecting and reporting the main features, and make comparisons where relevant.\n\nWrite at least 150 words.",
    diagramSvg: DIAGRAM_ENROLMENT,
    minWords: 150,
    timeLimit: 1200,
  },
  {
    taskType: 1,
    prompt: "The bar chart below compares the average number of hours worked per week by men and women in five countries.\n\nSummarise the information by selecting and reporting the main features, and make comparisons where relevant.\n\nWrite at least 150 words.",
    diagramSvg: DIAGRAM_WORKING_HOURS,
    minWords: 150,
    timeLimit: 1200,
  },
  {
    taskType: 1,
    prompt: "The line graph below shows the unemployment rate in two countries between 2005 and 2020.\n\nSummarise the information by selecting and reporting the main features, and make comparisons where relevant.\n\nWrite at least 150 words.",
    diagramSvg: DIAGRAM_UNEMPLOYMENT,
    minWords: 150,
    timeLimit: 1200,
  },
  {
    taskType: 1,
    prompt: "The diagram below illustrates the process by which chocolate is produced.\n\nSummarise the information by selecting and reporting the main features.\n\nWrite at least 150 words.",
    diagramSvg: DIAGRAM_CHOCOLATE_PROCESS,
    minWords: 150,
    timeLimit: 1200,
  },
  {
    taskType: 1,
    prompt: "The bar chart below shows the number of books borrowed from a public library in five genres in 2015 and 2020.\n\nSummarise the information by selecting and reporting the main features, and make comparisons where relevant.\n\nWrite at least 150 words.",
    diagramSvg: DIAGRAM_LIBRARY,
    minWords: 150,
    timeLimit: 1200,
  },
  {
    taskType: 1,
    prompt: "The pie charts below show how fresh water is used in two different regions of the world.\n\nSummarise the information by selecting and reporting the main features, and make comparisons where relevant.\n\nWrite at least 150 words.",
    diagramSvg: DIAGRAM_WATER_USE,
    minWords: 150,
    timeLimit: 1200,
  },
  {
    taskType: 1,
    prompt: "The line graph below shows the number of annual visitors to three museums between 2016 and 2022.\n\nSummarise the information by selecting and reporting the main features, and make comparisons where relevant.\n\nWrite at least 150 words.",
    diagramSvg: DIAGRAM_MUSEUM,
    minWords: 150,
    timeLimit: 1200,
  },
  {
    taskType: 1,
    prompt: "The table below shows the number of reported crimes per 10,000 people in four cities in 2022.\n\nSummarise the information by selecting and reporting the main features, and make comparisons where relevant.\n\nWrite at least 150 words.",
    diagramSvg: DIAGRAM_CRIME,
    minWords: 150,
    timeLimit: 1200,
  },
  {
    taskType: 1,
    prompt: "The bar chart below shows carbon dioxide emissions per person in five countries in 2000 and 2020.\n\nSummarise the information by selecting and reporting the main features, and make comparisons where relevant.\n\nWrite at least 150 words.",
    diagramSvg: DIAGRAM_CO2,
    minWords: 150,
    timeLimit: 1200,
  },
  {
    taskType: 1,
    prompt: "The line graph below shows the amount of coffee and tea consumed per person each year between 1990 and 2020.\n\nSummarise the information by selecting and reporting the main features, and make comparisons where relevant.\n\nWrite at least 150 words.",
    diagramSvg: DIAGRAM_COFFEE_TEA,
    minWords: 150,
    timeLimit: 1200,
  },
  {
    taskType: 1,
    prompt: "The pie charts below show how people travel to work in two different cities.\n\nSummarise the information by selecting and reporting the main features, and make comparisons where relevant.\n\nWrite at least 150 words.",
    diagramSvg: DIAGRAM_TRANSPORT,
    minWords: 150,
    timeLimit: 1200,
  },
  {
    taskType: 1,
    prompt: "The line graph below shows life expectancy at birth in three countries between 1970 and 2020.\n\nSummarise the information by selecting and reporting the main features, and make comparisons where relevant.\n\nWrite at least 150 words.",
    diagramSvg: DIAGRAM_LIFE_EXPECTANCY,
    minWords: 150,
    timeLimit: 1200,
  },
  {
    taskType: 1,
    prompt: "The bar chart below shows the percentage of retail sales made online for five types of product in 2014 and 2024.\n\nSummarise the information by selecting and reporting the main features, and make comparisons where relevant.\n\nWrite at least 150 words.",
    diagramSvg: DIAGRAM_SHOPPING,
    minWords: 150,
    timeLimit: 1200,
  },
  {
    taskType: 1,
    prompt: "The pie charts below show the sources of electricity generation in a country in 2005 and 2023.\n\nSummarise the information by selecting and reporting the main features, and make comparisons where relevant.\n\nWrite at least 150 words.",
    diagramSvg: DIAGRAM_ELECTRICITY_MIX,
    minWords: 150,
    timeLimit: 1200,
  },
